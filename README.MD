...
|------------|-------------|-------|
| Deep Past Initiative submission - SUB V1 | **19.3** | Flan-T5-base |

> Best entry scored **19.3** (geometric mean of BLEU and chrF++), using a single fine-tuned Flan-T5-base model without external data augmentation.
